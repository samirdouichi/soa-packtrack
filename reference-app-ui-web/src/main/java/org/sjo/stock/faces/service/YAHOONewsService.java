...
//			.getLogger(YAHOONewsService.class.getName());
//
...
//					title = title.length() <= 25 ? title : title.substring(0,
//							25);
//					entries.add(new NewsEntry(i, title + "...", entry
...
//					"Error in retrieving news from YAHOO: {0}",
